...
def train_model(X_train, y_train, X_val, y_val,weights_path="D:\\AbyssOrder\\Abyss-Order\\weights\\lstm_model_weights.h5"):
...
def main():
    ...
    test_file = "D:\\AbyssOrder\\Abyss-Order\\datasets2\\test2\\27272772bot.csv"
